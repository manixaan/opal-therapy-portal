...
function availabilityFor(def, runtime) {
  ...
  // Implemented, but something concrete is stopping it here. Never a rights
  // sentence: this branch is only ever reached for a technical fault or an
  // environment switch, and it says which.
  if (def.module) {
