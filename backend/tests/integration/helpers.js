...
const ALL_TABLES = [
  ...
  'tutorial_progress',
  // Owner-authorable walkthrough catalogue (045) — children before parents
  'walkthrough_module_versions', 'walkthrough_modules',
  ...
  'onboarding_field_candidates', 'employee_vehicles', 'onboarding_pack_defaults',
  'onboarding_pack_items',
