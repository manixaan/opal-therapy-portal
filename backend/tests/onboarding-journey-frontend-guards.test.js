...
describe('the changed assets are cache-busted', () => {
  test('both onboarding assets carry the new version', () => {
    ...
    expect(SHELL).toContain('src="/onboarding.js?v=12"');
    expect(SHELL).toContain('src="/onboarding-journey.js?v=36"');
    expect(SHELL).toContain('href="/onboarding-journey.css?v=23"');
  });
