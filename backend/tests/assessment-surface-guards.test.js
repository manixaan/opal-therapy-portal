...
describe('changed assets are cache-busted', () => {
  test('every asset this feature changed carries a bumped ?v=', () => {
    ...
    for (const [file, version] of [
      ...
      ['resourcehub.js', 'r52'], ['resourcehub.css', 'r30'],
      ...
      ['onboarding.js', 15], ['onboarding.css', 8],
      ...
      ['onboarding-journey.js', 79], ['onboarding-journey.css', 42],
