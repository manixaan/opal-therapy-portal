...
const INDUCTION_SUPPLEMENT = [
  ...
  { code: 'IND_SPLOSE_ACTIVE', title: 'Splose account activated', section: 'accounts', sortOrder: 300, sends: false, returns: false, verifies: false, required: true, rule: R.PARTICIPANT_FACING, itemKind: 'account', linkedTaskCode: 'splose_access', description: 'Marked ready when the internal set-up task is done.' },
