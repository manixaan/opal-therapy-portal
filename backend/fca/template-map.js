 ...
 *
 * VERIFIED TEMPLATE FACTS (fca-v1.docx, sha256 417cf13b…2d3254 — re-hashed
 ...
 * physical sizes follow the Anti-Bribery and Corruption Standard PDF: Arial 11pt body on 1.25 lines, 14pt H1, 9pt tables and footer, 1in side margins; the logo sits in the running header band; 18 Sep 2026: document-control page removed with its reviewer/status rows moved into the Professional Declaration, all page-break-before flags dropped, contents list re-tabbed to the 1in column; 20 Sep 2026: 9 blank lines end the cover (12 fit; 36 was a misread that left page 2 empty) so Contents starts on page 2 with no page break; label/value tables moved to the new 'OPAL – Details Table' gallery style — dark first column with white text, no header row — and body text colour moved into the document defaults so a table style's white is never overridden; the duplicate TOC1–3 styles merged into single ones under Word's own 'toc N' names)
...
const SCALAR_TAGS = [
  ...
  { tag: 'OPAL_CLIENT_FULL_NAME', label: 'Full name', layer: 'splose', field: 'fullName', occurrences: 3, parts: ['word/header6.xml'] },
  { tag: 'OPAL_CLIENT_NDIS_NUMBER', label: 'NDIS number', layer: 'splose', field: 'ndisNumber', occurrences: 3, parts: ['word/header6.xml'] },
  ...
  { tag: 'OPAL_THERAPIST_FULL_NAME', label: 'Assessor name', layer: 'portal', field: 'therapistName', occurrences: 4 },
  { tag: 'OPAL_THERAPIST_CREDENTIALS', label: 'Assessor credentials', layer: 'portal', field: 'therapistRoleTitle', occurrences: 3 },
  ...
  { tag: 'OPAL_REPORT_ISSUE_DATE', label: 'Issue date', layer: 'report', isDate: true, occurrences: 1,
