...
(function (global) {
  ...
  function tabAllowed(tab) {
    if (inList(PAGE_TABS, tab)) {
      // Owned by its own module. If the module has not loaded, restoring is a
      // no-op anyway and the fallback below would be the wrong answer.
      return !!(global.Assess && isFn(global.Assess.openRecord));
    }
